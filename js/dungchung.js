    ...
    <div class="header group">
        ...
        <div class="content">
            <div class="search-header">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="Nhập tên sách cần tìm...">
                        <button type="submit">
                            <i class="fa fa-search"></i>
                            Tìm kiếm
                        </button>
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="javascript:void(0)" onclick="showTaiKhoan(true)">
                            <i class="fa fa-sign-in"></i>
                            Đăng nhập
                        </a>
                        <a href="javascript:void(0)" onclick="showTaiKhoan(true, true)">
